                                ...
                                <tr key={admin._id} className="hover:bg-slate-50/80 dark:hover:bg-slate-800/80 transition-colors group">
                                    ...
                                    <td className="p-5 text-right align-middle">
                                        <div className="flex items-center justify-end gap-2 transition-opacity">
                                            ...
                                            <a href={`${window.location.hostname === 'localhost' ? 'http://localhost:5175' : 'https://digital-card-customer-frontend.vercel.app'}/${admin.slug || (admin.username ? admin.username.split('@')[0] : 'admin')}`} target="_blank" rel="noreferrer" title="View Digital Card" className="flex items-center justify-center p-2.5 text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg hover:bg-emerald-600 dark:hover:bg-emerald-600 hover:text-white dark:hover:text-white shadow-sm hover:scale-105 active:scale-95 transition-all">
                                                <Eye size={16} />
                                            </a>
                                            {/* Manage NFC Button */}
